...
module.exports = {
  botname: process.env.BotName || "Azula", 
  ...
  ownername: process.env.Owner_Name || "kaneki",
  ownernumber: process.env.Owner_Number || "+2348145317097",
  adress: process.env.Continent || "Nigeria",
  timezone: process.env.TimeZone || "NIGERIA/Africa", 
  instagramId: process.env.Insta || "paroll99",
  email: process.env.Email_Id || "parolly99@gmail.com",
